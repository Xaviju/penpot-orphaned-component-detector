  ...
  if (event.data) {
    ...
    if (event.data.type === "orphaned") {
      ...
      orphanedComponents.forEach((shape: PenpotShape) => {
        ...
        componentListItemIcon.innerHTML = icons.component;
